...
export const RegistrosLibro: React.FC<Props> = ({ registros, onRefresh }) => {
  ...
  return (
    ...
    >
      ...
      <section>
        <div
          className="overflow-y-auto rounded-lg border shadow-md transition-all duration-300
        "
        >
          <AnimatePresence>
            {filtered.length === 0 ? (
              ...
              filtered.map((r) => (
                ...
                group-open:border-gray-700 "
                  >
                    ...
                    <span
                      className="text-sm text-gray-400 group-open:hidden 
                  ...
                  rounded-b-lg group-open:bg-gray-800 group-open:border-t-0
                  group-open:border-gray-700 group-open:shadow-md 
                  group-open:shadow-gray-700
                  group-open:group-hover:bg-gray-800 group-open:group-hover:border-gray-500"
                  >
                    {r.description}
                  </motion.div>
                </motion.details>
