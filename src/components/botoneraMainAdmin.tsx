...
export const BotoneraMainAdmin: React.FC<BotoneraMainAdminProps> = ({
  ...
  return (
    <div
      className="relative flex flex-col items-center gap-4 mt-4 text-white bg-black p-4 rounded-2xl border border-violet-500 animate-pulse-slow -mb-8 
    ...
    >
      <Link
        href="/"
        className="relative translate-y-118 text-3xl hover:opacity-70 cursor-pointer  animate-pulse-slow"
      >
        ←
      </Link>
